    ...
    <div id="recaptcha-resend-container"></div>
      ...
      >
        ...
        <FormControl id="email" isRequired>
          ...
          <Input
            placeholder="Enter in which department you are"
            onChange={(e) => {
        ...
        <FormControl id="email" isRequired>
          ...
          <Input
            placeholder="Enter in which year you are"
            onChange={(e) => {
        ...
        <FormControl id="email" isRequired>
          ...
          <Input
            placeholder="Enter in which division you are"
            onChange={(e) => {
